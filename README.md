...
✅ Register (if needed) and Sign In to Astra DB [https://astra.datastax.com]( https://astra.dev/cassandra-day-singapore): You can use your `Github`, `Google` accounts or register with an `email`.
